...
void Graph::addMenu1()
{
	...
	auto item_5 = MenuItemLabel::create(labelViewMatrix, CC_CALLBACK_1(Graph::viewMenu2, this));
	...
	auto item_6 = MenuItemLabel::create(labelViewTrajectories, CC_CALLBACK_1(Graph::viewMenu3, this));
	...
	auto item_7 = MenuItemLabel::create(labelViewCircuits, CC_CALLBACK_1(Graph::viewMenu4, this));
	...
	auto item_8 = MenuItemLabel::create(labelReturn, CC_CALLBACK_1(Graph::goToMenus, this));
	...
	auto item_9 = MenuItemLabel::create(labelZoomIn, CC_CALLBACK_1(Graph::zoomIn, this));
	...
	auto item_10 = MenuItemLabel::create(labelZoomOut, CC_CALLBACK_1(Graph::zoomOut, this));
...
void Graph::addMenu2()
{
	...
	auto item_1 = MenuItemLabel::create(labelBack, CC_CALLBACK_1(Graph::viewMenu1, this));
	item_1->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_1->setPosition(Vec2(x, y));
	...
	auto item_2 = MenuItemLabel::create(labelIncidence, CC_CALLBACK_1(Graph::viewMatrixIncidence, this));
	item_2->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_2->setPosition(Vec2(x, y));
	...
	auto item_3 = MenuItemLabel::create(labelAdjacency, CC_CALLBACK_1(Graph::viewMatrixAdjacency, this));
	item_3->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_3->setPosition(Vec2(x, y));
...
void Graph::addMenu3()
{
	...
	auto item_2 = MenuItemLabel::create(labelIncidence, CC_CALLBACK_1(Graph::newTrajectory, this));
	item_2->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_2->setPosition(Vec2(x, y));
	...
	auto item_3 = MenuItemLabel::create(labelAdjacency, CC_CALLBACK_1(Graph::viewTrajectory, this));
	item_3->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_3->setPosition(Vec2(x, y));
	...
	auto item = MenuItemLabel::create(labelBack1, CC_CALLBACK_1(Graph::newTrajectory, this));
...
void Graph::addMenu4()
{
	...
	auto item_2 = MenuItemLabel::create(labelIncidence, CC_CALLBACK_1(Graph::addNodes, this));
	item_2->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_2->setPosition(Vec2(x, y));
	...
	auto item_3 = MenuItemLabel::create(labelAdjacency, CC_CALLBACK_1(Graph::addNodes, this));
	item_3->setAnchorPoint(Vec2(0.5f, 0.5f));
	item_3->setPosition(Vec2(x, y));
...
void Graph::newTrajectory(Ref *sender)
{
...
void Graph::viewTrajectory(Ref *sender)
{
	for (int i = 0; i < _MatrixTrajectory.size();i++)
	{
		this->removeChild(_MatrixTrajectory.at(i));
...
float Graph::distance(Vec2 position1, Vec2 position2)
{
...
void Graph::positionLabel(Label* label, Vec2 position1, Vec2 position2)
{
...
float Graph::angle(Vec2 position1, Vec2 position2)
{
...
void Graph::createRelation(int indexNode1, int indexNode2)
{
	...
	auto relation = Sprite::create("images/edge.png");
	...
	//cocos2d::log("angulo: %f",angleNodes);
...
void Graph::cameraToOrigin(int mode)
{
	float x = this->getDefaultCamera()->getPositionX();
	float y = this->getDefaultCamera()->getPositionY();
	float z = this->getDefaultCamera()->getPositionZ();
...
void Graph::viewMatrixAdjacency(Ref* sender)
{
	...
	for (int i = 0; i < jointssize; i++)
	{
		for (int j = i+1; j < jointssize; j++)
		{
			if (_joints[i].bodyEdge == _joints[j].bodyEdge)
			{
				...
				_MatrixAdjacency.at(k + l * size)->setString("1");
...
void Graph::viewMatrixIncidence(Ref* sender)
{
	for (int i = 0; i < _MatrixAdjacency.size(); i++)
		this->removeChild(_MatrixAdjacency.at(i));
	_MatrixAdjacency.clear();
...
void Graph::viewMenu1(Ref *sender)
{
...
void Graph::viewMenu2(Ref *sender)
{
...
void Graph::viewMenu3(Ref *sender)
{
	_menu1->setOpacity(0.0f);
	_menu1->setScale(0.0f);
	_menu3->setOpacity(255.0f);
...
void Graph::viewMenu4(Ref *sender)
{
	_menu1->setOpacity(0.0f);
	_menu1->setScale(0.0f);
